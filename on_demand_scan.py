...
###
#API_KEY = "551fdb26429f338fec5cb2f1b6b23514"
...
i = 30  # We should have some data to play with after 30m, so bail out
while i > 0:
    sleep(60)
    ...
    if status.get("total_assets") > 0 and status.get("scan_activity_in_last_5m") == 0:
        break
    i -= 1
